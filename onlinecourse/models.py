...
# Question model
# A question belongs to a lesson, carries the question text and a grade point
class Question(models.Model):
    ...
    # A question is answered correctly only when the learner picked every
    # correct choice and none of the incorrect ones
...
# Choice model
# One question could have multiple choices, one or more of them being correct
